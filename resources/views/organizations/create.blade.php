...
@section('content')
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-3xl font-bold text-white">Tambah Data Organisasi</h2>
                <p class="text-slate-400 mt-1">Tambahkan organisasi baru ke sistem.</p>
            </div>
            ...
            <form action="{{ route('organizations.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="address"
                        class="w-full rounded-xl border border-slate-700 bg-[#111827] px-4 py-3 text-white">{{ old('address') }}</textarea>
                </div>
