...
@section('content')
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <h2 class="text-3xl font-bold tracking-wide text-white">Edit Data Desa</h2>
                <p class="text-slate-400 mt-1">Perbarui informasi desa pada sistem.</p>
            </div>
        ...
        <div class="rounded-2xl border border-slate-700/60 bg-[#0b1220]/90 shadow-lg p-6 md:p-8">
            ...
            <form action="{{ route('villages.update', $village->id) }}" method="POST" class="space-y-5">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name', $village->name) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="regency" value="{{ old('regency', $village->regency) }}"
                            class="w-full rounded-xl border border-slate-700 bg-[#111827] px-4 py-3 text-white focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/30">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="postal_code" value="{{ old('postal_code', $village->postal_code) }}"
                            class="w-full rounded-xl border border-slate-700 bg-[#111827] px-4 py-3 text-white focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/30">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" rows="4"
                            class="w-full rounded-xl border border-slate-700 bg-[#111827] px-4 py-3 text-white focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/30">{{ old('address', $village->address) }}</textarea>
                    </div>
