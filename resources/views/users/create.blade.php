...
@section('content')
    <div class="max-w-3xl bg-[#0b1220] border border-slate-700 rounded-xl shadow p-6">
        <h2 class="text-2xl font-bold mb-6 text-white">Tambah User</h2>
        ...
        <form action="{{ route('users.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <select name="organization_id" class="w-full border border-slate-700 bg-[#111827] text-white rounded px-3 py-2">
            ...
            <div class="flex items-center gap-2 text-slate-300">
                <input type="checkbox" name="is_active" value="1" checked class="accent-cyan-500">
